...
import type { TemplateDetail, TemplateRule, TemplateSummary } from '../domain/types'
...
export const useTemplateStore = defineStore('templates', () => {
  ...
  async function loadTemplate(id: string) { return run(async () => (selected.value = await apiClient.getTemplate(id))) }
  ...
  return { templates, selected, loading, error, publishedTemplates, loadTemplates, loadTemplate, upload, updateRule, addRule, deleteRule, publish, retire }
})
